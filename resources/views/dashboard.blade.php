            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-5">
                    ...
                    <div >
                        ...
                        <a href="{{ url('/auth/linkedin') }}" class="block w-full text-center py-2 rounded bg-blue-700 hover:bg-blue-800 text-white font-semibold transition duration-200">Connect with LinkedIn</a>
                    </div>
                </div>
            </div>
        </div>
